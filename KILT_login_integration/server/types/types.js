/*import {
  ...
  import { KILT_CREDENTIAL_IRI_PREFIX } from '../utilities/wellKnownDidConfiguration.js'
  ...
  */
  export function fromCredentialIRI(credentialId){
  ...
  export function toCredentialIRI(rootHash) {
